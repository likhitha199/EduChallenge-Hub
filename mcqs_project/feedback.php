...
<div class="col-md-10">
<a href="mailto:info@gpcet.ac.in" style="color:#000000">info@gpcet.ac.in</a><br /><br />
...
<a href="http://www.gpcet.ac.in" target="_blank">About us</a>
</div>
<div class="col-md-3 box">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
     ...
     <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="CAM00121.png" width=100 height=100 alt="Sunny Prakash Tiwari" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		 <pre style="color:#202020; font-family:'typo' ; font-size:18px" >Shaheen  Likitha  Sana</pre>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 77996 96385/86</h4>
		<h4 style="font-family:'typo' ">info@gpcet.ac.in</h4>
		<h4 style="font-family:'typo' ">G.Pullaiah College of Enginnering and Technology</h4></div></div>
		</p>
      </div>
